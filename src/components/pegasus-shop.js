...
const pegasusApp = {
   ...
   renderHTML: function () {
    const pegasusShopHTML = this.imgSrc().map ( (img) => {
    return `<div class="col-lg-4 col-md-6 col-12 mb-4">
    <div class="w-100">
        <img class="w-100 cursor-pointer pegasus__img" src="${img.link}" alt="">
        <div class="mt-3">
            ...
            <p class="m-2 text-secondary">${img.description.des4}</p>
